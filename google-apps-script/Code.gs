...
function sheetObjectHeaders_(name) {
  const map = {
    ...
    EventBookings: ["id", "customerName", "phoneNumber", "roomId", "roomName", "eventAt", "depositAmount", "depositPaymentMethod", "description", "status", "createdAt", "createdBy", "eventEndAt", "packageType", "guestCount", "totalPackagePrice"],
    ...
    switch (body.action) {
      ...
      case "addEventBooking": {
        ...
        const bookingItem = {
          ...
          eventAt: Number(body.eventAt), eventEndAt: body.eventEndAt ? Number(body.eventEndAt) : null,
          packageType: body.packageType || null, guestCount: body.guestCount ? Number(body.guestCount) : null,
          totalPackagePrice: body.totalPackagePrice ? Number(body.totalPackagePrice) : null,
